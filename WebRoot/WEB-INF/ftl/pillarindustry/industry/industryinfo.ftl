...
<head>
    ...
    function goback(){
		...
		//location="${rc.contextPath}/pillarindustry/opt-query/industrylist";
    	window.history.go(-1); 
    }
...
<body>
    <div class="content-box">
        ...
        <form class="form-inline search_list" role="form"  id="editGardenIntroduceForm" method="post" action="${rc.contextPath}/pillarindustry/opt-save/saveindustry.do">
	    ...
	    <div class="row">
	        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
	            <div class="input-group w textbox">
	                <span class="input-group-addon">产业概况</span>
	               
	                <textarea  cols="12" rows="15"  class="form-control" id="content"  name="content" placeholder="请输入概况内容" >${industry.introduce!""}</textarea>
	            </div>
	        </div>
	    </div>
        ...
        <div class="row">      
	        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	            <div class="input-group" id="uploadImg">
	                <span class="input-group-addon">概况图片<span style="color:red;"></span></span>
	                <input type="text" class="form-control"   id="image" name="introducePic" value="${industry.introducePic!''}" placeholder="请上传图片" style="width:200px;" readonly="readonly" >
	  ...
	  <#if  (industry.introducePic)?? && ((industry.introducePic)+"")!="">
	  style="display:block;"
	  <#else>
	  style="display:none;"
	  </#if> >  
           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	  			<img src="/gykjy/plugins/images/allImages/${(industry.introducePic)!''}" id="theimg" class="mr10 fl" width="40%"/>
	  	   </div>
      </div>
