...
<body>
    <div class="content-box">
        <!--form-->
        <div class="page-header"><h2>产业新闻<small class="font-en caps"></small></h2></div>
        <form class="form-inline search_list" role="form"  id="searchForm" method="post" action="${rc.contextPath}/pillarindustry/opt-query/newslist.do">
        <div id="searchDiv">
            <div class="row">
        	...
        	<div class="row" >
	        	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		            <div class="input-group">
		                <span class="input-group-addon">模块名称</label></span>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover mytable">
                <thead>
                    <tr>
                    	<th width="4%"><input type='checkbox' id="chooseall" ></input></th>
                        <th width="5%">序号</th>
                        <th width="10%">标题</th>
                        <th width="10%">所属模块</th>
                        <th width="10%">数据来源</th>
                    ...
                    <#if page??>
						<#list page.list as news>
							<tr>
								...
								<td><div class="zjh">${(news.GNAME)!"主模块" }</div></td>
...
<script type="text/javascript">
	...
	function changeStatus(newsId,value){
		...
		window.location.href="${rc.contextPath}/pillarindustry/opt-update/changestatus.do?id="+newsId+"&pageNo="+pageNo+"&pageSize="+pageSize+"&value="+value;
	}
	...
	function editNews(newsId){
		var pageNo = $("#pageNo").val();
		var pageSize = $("*[name='pageSize']").val(); 
		window.location.href="${rc.contextPath}/pillarindustry/opt-edit/editnews.do?id="+newsId+"&pageNo="+pageNo+"&pageSize="+pageSize;
	}
	...
	function addNews(){
		var pageSize = $("*[name='pageSize']").val(); 
		window.location.href="${rc.contextPath}/pillarindustry/opt-add/addnews.do?pageSize="+pageSize;
	}
	
	//查看新闻
	function newsInfo(newsId){
		window.location.href="${rc.contextPath}/pillarindustry/opt-view/newsinfo.do?id="+newsId;		
	}
	...
	function sure(str){
		var pageNo = $("#pageNo").val();
		var pageSize = $("*[name='pageSize']").val(); 
		window.location.href="${rc.contextPath}/pillarindustry/opt-del/delnews.do?ids="+str+"&pageSize="+pageSize+"&pageNo="+pageNo;
	}
