            ...
            <div class="row">
	           <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		          <div class="input-group" >
		             <span class="input-group-addon">模块名称 <span style="color:red;">*</span></label></span>
		             <select class="form-control" name="parentCode" id="parentCode" style="width:235px;">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		            <div class="input-group">
		                ...
		                <input type="text" class="form-control" id="newsTitle" name="newsTitle" placeholder="请输入标题" style="width:600px;" value="${(gardenNews.newsTitle)!''}" >
		            </div>
		        </div>
            </div>
...
<script type="text/javascript">
	...
	//取消
	function goBacks(){
		//window.location.href="${rc.contextPath}/pillarindustry/opt-query/newslist.do";
		window.history.go(-1);
	}
	...
	function save(){
	    if(validate_form("addOrEditNews")){
	        ...
	        $("#addOrEditNews").attr("action","${rc.contextPath}/pillarindustry/opt-save/savenews.do")
	...
	function validate_form(formid){
    		...
    		tt.checkLength("parentCode","模块名称",true,1,100);
    		tt.checkLength("status","状态",true,1,100);
    		return tt.validate();
    }
