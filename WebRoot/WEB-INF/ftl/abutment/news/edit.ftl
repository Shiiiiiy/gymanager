...
<body>
    ...
    <div class="content-box">
        ...
        <form class="form-inline search_list" role="form"  id="addOrEditNewsAll" method="post" action="${rc.contextPath}/policynews/opt/save">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		            <div class="input-group">
		                ...
		                <input type="text" class="form-control" id="newsTitle" name="newsTitle" placeholder="请输入标题名称" style="width:600px;" value="${(newsAll.newsTitle)!''}" >
		            </div>
		        </div>
            </div>
        	...
        	<div class="row">	
	            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
	            	<a class="btn blue" href="javaScript:void(0)" onclick="save();"><i class="icon-ok"></i> 保存</a>
...
<script type="text/javascript">
	...
	//取消
	function goBacks(){
		window.location.href="${rc.contextPath}/abutment/query/index?tab=2&moduleCode=${(moduleCode)!''}&pageNo=${pageNo!""}&pageSize=${pageSize!""}";
	}
	...
	function save(){
	    if(validate_form("addOrEditNewsAll")){
	        ...
	        $("#addOrEditNewsAll").attr("action","${rc.contextPath}/abutmentnews/opt/save");
