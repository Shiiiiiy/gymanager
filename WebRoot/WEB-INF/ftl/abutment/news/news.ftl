...
$(function(){
	...
	$("#searchForm").submit(function(event){
		...
		changeTab("2",newsTitle,newsSource,newsTime,null,null,pageNo,pageSize);
	});
...
function changeStatus(id,value){
	...
	window.location.href="${rc.contextPath}/abutmentnews/opt/changestatus?id="+id+"&pageNo="
...
function editNews(newsId){
	...
	window.location.href="${rc.contextPath}/abutmentnews/opt/edit?id="+newsId+"&pageNo="+pageNo+"&pageSize="+pageSize+"&moduleCode="+moduleCode;
}
...
function addNews(){
	var pageNo = $("#pageNo").val();
	var pageSize = $("*[name='pageSize']").val(); 
	window.location.href="${rc.contextPath}/abutmentnews/opt/edit?moduleCode=${(moduleCode)!''}&pageSize="+pageSize+"&pageNo="+pageNo;
}

//查看新闻
function newsInfo(newsId){
	window.location.href="${rc.contextPath}/abutmentnews/query/view?moduleCode=${(moduleCode)!''}&id="+newsId;		
}
...
function sure(str){
	window.location.href="${rc.contextPath}/abutmentnews/opt/delete?moduleCode=${(moduleCode)!''}&ids="+str;
}
