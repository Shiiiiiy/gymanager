...
<body>
    ...
    <div class="content-box">
        ...
        <div class="page-header">
        	<h2>
        	        <#if userInstitutionMap?? && userInstitutionMap.GID?? >
	        			编辑
	        		<#else>
	        			新增
	        		</#if>
          ...
          <form class="form-inline search_list" role="form"  id="addOrEditUser" method="post" action="${rc.contextPath}/userManage/opt-save/saveUserInstitution?pageNo=${pageNo!""}&pageSize=${pageSize!""}">
        <div class="tabfix">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="1">
		            ...
		            <input type="hidden" id="guserId" name="id" value="${(userInstitutionMap.GID)!''}"/>
		            <input type="hidden" id="institutionId" name="institutionId" value="${(userInstitutionMap.ID)!''}"/>
		            ...
		            <div class="row">
			           <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				            <div class="input-group">
				                ...
				                <input type="text" class="form-control" id="username" name="username" placeholder="请输入用户名" style="width:200px;" value="${(userInstitutionMap.USERNAME)!''}" >
				            </div>
				        </div>
				    </div>   
				    <div class="row">
				        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				            <div class="input-group">
				                ...
				                <input type="password" class="form-control" id="password" name="password" placeholder="请输入用户密码" style="width:200px;" value="<#if userInstitutionMap??>********</#if>" >
				            </div>
				        </div>
				    </div>  
			            ...
			            <div class="row">  
				             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			                    <div class="input-group" id="uploadImg">
			                        ...
			                        <input type="text" class="form-control"   id="image" name="image_name" placeholder="请上传头像" style="width:200px;" readonly="readonly" value="${(userInstitutionMap.IMAGE1)!''}">
			                ...
			                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="touxiang" <#if userInstitutionMap?? && userInstitutionMap.IMAGE1?? && userInstitutionMap.IMAGE1!=""> <#else>style="display:none;"</#if> >
			                    <div class="input-group" >
			                      <#if userInstitutionMap?? && userInstitutionMap.IMAGE1?? && userInstitutionMap.IMAGE1!=""> 
			                        <img id="viewImage" src="/gykjy/plugins/images/allImages/${(userInstitutionMap.IMAGE1)!''}" style="max-width:200px;max-height:150px;" />
			                      </#if>
			                    </div>
			       ...
			       <div class="row"> 
			            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
			                <div class="input-group">
			                    ...
			                    <textarea class="form-control" id="comment" name="comment" placeholder="请输入备注信息" style="width:450px;height:100px;">${(userInstitutionMap.COMMENT)!""}</textarea>
			                </div>
			            </div>
		            </div>
                ...
                <div class="row">       
	                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="nameIn" name="nameIn" placeholder="请输入机构名称" style="width:200px;" value="${(userInstitutionMap.NAME)!''}" >
					            </div>
	                ...
	                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="linkMan" name="linkMan" placeholder="请输入联系人" style="width:170px;" value="${(userInstitutionMap.LINKMAN)!''}" >
					            </div>
	                ...
	                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="telIn" name="telIn" placeholder="请输入手机号码" style="width:170px;" value="${(userInstitutionMap.TEL)!''}" >
					            </div>
                ...
                <div class="row">
	                 <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="phoneIn" name="phoneIn" placeholder="请输入座机号码" style="width:200px;" value="${(userInstitutionMap.PHONE)!''}" >
					            </div>
	                ...
	                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="orgCode" name="orgCode" placeholder="请输入组织机构代码" style="width:170px;" value="${(userInstitutionMap.ORGCODE)!''}" >
					            </div>
	                 ...
	                 <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="socialCode" name="socialCode" placeholder="请输入社会信用代码" style="width:170px;" value="${(userInstitutionMap.SOCIALCODE)!''}" >
					            </div>
                ...
                <div class="row">
	                 ...
	                 <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					       <div class="input-group">
							    ...
							    <select class="form-control" name="province" id="province" style="width:200px;" onchange="getCityOrArea('A',this)">
			                        <option   value="">请选择..</option>
			                               <#if mylist??>
			                                       <#list mylist as mt>
			                                       		<#if userInstitutionMap?? && userInstitutionMap.PROVINCE?? && userInstitutionMap.PROVINCE== mt.ID >
			         ...
			         <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">      
			               <div class="input-group">     
			                    ...
			                    <select class="form-control" name="city" id="city"  onchange="getArea(this)"  style="width:172px;">
			                        <option  value="">请选择..</option>
			                       	<#if CITYlist??>
			                        <#list CITYlist as mt>
			                       		<#if userInstitutionMap?? && userInstitutionMap.CITY?? && (userInstitutionMap.CITY+"")==(mt.ID+"") >
			                                 <option value="${(mt.ID)!''}"  name="${(mt.CODE)!''}" selected = "selected">${(mt.NAME)!""}</option>
			                            <#else>
			                                 <option value="${(mt.ID)!''}"  name="${(mt.CODE)!''}">${(mt.NAME)!""}</option>
			                        	</#if>
			        ...
			        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">             
			             <div class="input-group">    
			                    ...
			                    <select class="form-control" name="area" id="area" style="width:172px;">
			                        <option  value="">请选择..</option>
			                       	<#if AREAlist??>
			                        <#list AREAlist as mt>
			                       		<#if userInstitutionMap?? && userInstitutionMap.AREA?? && userInstitutionMap.AREA==mt.ID >
			                                 <option value="${(mt.ID)!''}"  name="${(mt.CODE)!''}" selected = "selected">${(mt.NAME)!""}</option>
			                            <#else>
			                                 <option value="${(mt.ID)!''}" name="${(mt.CODE)!''}" >${(mt.NAME)!""}</option>
			                        	</#if>
                ...
                <div class="row">
                     <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                ...
					                <input type="text" class="form-control" id="emailIn" name="emailIn" placeholder="请输入邮箱" style="width:200px;" value="${(userInstitutionMap.EMAIL)!''}" >
					            </div>
	                </div>
                     <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					            <div class="input-group">
					                <span class="input-group-addon">&nbsp;&nbsp;详&nbsp;细&nbsp;地&nbsp;址&nbsp;</span>
					                <input type="text" class="form-control" id="address" name="address" placeholder="请输入详细地址" style="width:542px;" value="${(userInstitutionMap.ADDRESS)!''}" >
					            </div>
...
<script type="text/javascript">
	...
	function goBacks(){
		...
		window.location.href="${rc.contextPath}/userManage/opt-query/institutionList.do?flag=1";
	}
	...
	function validate_form(formid){
    		...
    		tt.checkLength("nameIn","机构名称",false,1,30);
    		tt.checkLength("linkMan","联系人",false,1,32);
    		tt.checkLength("telIn","手机号码",false,1,11,isTheTel);
    		tt.checkLength("phoneIn","座机号码",false,1,13,isPhone);
    		tt.checkLength("orgCode","组织机构代码",false,1,40);
    		tt.checkLength("socialCode","社会信用代码",false,1,40);
    		tt.checkLength("emailIn","邮箱",false,1,20,isTheEmail);
    		tt.checkLength("address","通讯地址",false,1,100);
    ...
    function  checkUsername(){
    		...
    		if(true || regStr.test(username)){
        		$.ajax({
				     url:"${rc.contextPath}/userManage/opt-query/checkUsername.do?username="+encodeURI(encodeURI($("#username").val()))+"&userType=INSTITUTION&guserId="+$("#guserId").val(),
				     dataType:"json",
				     async:false,
				     type:"POST",
