        ...
        <div class="tabfix">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" id="tab1" class="tab-pane">
					...
					<span style="color:red;">* 最佳尺寸570X338像素</span>
					<div class="row">
						<#if fileList??>
                ...
                <div role="tabpanel" id="tab2" class="tab-pane">
					...
					<span style="color:red;">* 最佳尺寸570X315像素</span>
					<div class="row">
						<#if fileList??>
							<#list fileList as file>
...
<script type="text/javascript">
	...
	function callPerComplete(obj,data){
		...
		if(json.result){ //&& json.pictureFile)
			//将返回的地址信息存入数据库
			window.location.href="${rc.contextPath}/f1source/opt-add/saveF1source?fileName="+json.fileNameInServer+"&fileType="+type+"&flag="+flag;
		}
	}
	...
	function sure(fileId){
		...
		if(tt.validate()){
			...
			window.location.href="${rc.contextPath}/f1source/opt-update/updateFileTitle.do?fileId="+fileId+"&fileTitle="+encodeURI(encodeURI($("#fileTitle").val()))+"&url="+encodeURI(encodeURI($("#url").val()))+"&urlType="+urlType+"&sort="+$("#sort").val()+"&flag="+flag;
			showDialog_close("editDiv");
		}
	}
	
	function sure1(fileId){
		window.location.href="${rc.contextPath}/f1source/opt-delete/deleteFile.do?fileId="+fileId+"&flag="+flag;
	}
