...
<script type="text/javascript">
	...
	//取消
	function goBacks(){
		window.location.href="${rc.contextPath}/policynews/query/list?moduleCode=${(moduleCode)!''}&pageNo=${pageNo!"1"}&pageSize=${pageSize!"10"}";
	}
	...
	function save(){
	    if(validate_form("addOrEditNewsAll")){
	        ...
	        $("#addOrEditNewsAll").attr("action","${rc.contextPath}/policynews/opt/save");
