...
<script type="text/javascript">
	...
	function editTechInnovation(id){
		var pageNo = $("#pageNo").val();
		var pageSize = $("*[name='pageSize']").val();
		window.location.href="${rc.contextPath}/dynamicdata/opt-addOrEdit/addOrEditInvestCompanies.do?id="+id+"&modelType=${modelType}"+"&pageNo="+pageNo+"&pageSize="+pageSize;
	}
	
	
	//新增新闻
	function addTechInnovation(){
		window.location.href="${rc.contextPath}/dynamicdata/opt-addOrEdit/addOrEditInvestCompanies.do?modelType=${modelType}";
	}
	
	//查看新闻
	function info(id){
		window.location.href="${rc.contextPath}/dynamicdata/opt-query/investCompaniesInfo.do?id="+id;		
	}
