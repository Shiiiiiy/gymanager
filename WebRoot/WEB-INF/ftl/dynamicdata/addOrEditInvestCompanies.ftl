...
<body>
    ...
    <div class="content-box">
        ...
        <form class="form-inline search_list" role="form"  id="addOrEditModel" method="post" action="${rc.contextPath}/dynamicdata/opt-save/saveInvestCompanies.do?modelType=${modelType}">
	        ...
	        <div class="row">
	            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		            <div class="input-group">
		                <span class="input-group-addon">&nbsp;&nbsp;投资机构&nbsp;&nbsp;</span>
		                <input type="text" maxlength="32" class="form-control" id="investor" name="investor" placeholder="请输入投资机构" style="width:250px;" value="${(vo.investor)!''}">
		            </div>
		        </div>
	        </div> 
...
$(function () {
	...
	function save(){
	    if(validate_form("addOrEditModel")){
	        ...
	        $("#addOrEditModel").attr("action","${rc.contextPath}/dynamicdata/opt-save/saveInvestCompanies.do?modelType=${modelType}");
